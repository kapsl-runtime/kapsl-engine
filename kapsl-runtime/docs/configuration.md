...
| `KAPSL_GENERIC_NATIVE_PACKS` | Certification-only switch for backend-neutral ABI v1 ONNX packs; defaults to `0`, accepts only explicit boolean values, and never falls back to embedded ORT after selection |
