...
require_literal "$packager" 'package_profile cuda12 cuda cuda12'
require_literal "$packager" 'cuda12-shared-pool'
require_literal "$packager" 'KAPSL_LLAMA_SDK_REF'
...
for workflow in \
  ...
  require_literal "$workflow" 'KAPSL_LLAMA_SDK_REF'
  require_literal "$workflow" 'sdk-llama'
done
